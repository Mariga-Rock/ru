...
const caseStudies: CaseStudy[] = [
  {
    ...
    challenge:
      'Создать новый пользовательский интерфейс (UI) и пользовательский опыт (UX) для платформы государственного депозитария. Устаревший интерфейс не позволял масштабироваться и вынуждал операторов переключаться между пятью разрозненными системами для выполнения даже одной рабочей задачи.',
    approach:
  ...
  },
  {
    ...
    challenge:
      'Модернизировать UI и пользовательский опыт аналитической панели, сохранив все существующие функции. За время развития продукт накопил множество функций, а пользователи привыкли к определённым рабочим процессам.',
    approach:
      'Провела полное исследование продукта и пользовательского опыта, составила карту всех существующих функций до внесения визуальных изменений. Затем спроектировала полноценный редизайн, обновив визуальный слой и модель взаимодействия без потери функциональности.',
    result:
      'Новая версия ушла в последующие релизы, повысив ценность продукта',
    details: {
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed animate-on-scroll">
                ...
                <p>
                  Системный подход, ориентированный на бизнес и адаптированный к уникальным вызовам российского рынка.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-6 animate-on-scroll">
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100">
                ...
                <div className="text-gray-500 font-medium">человек в команде</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="services" className="py-14 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <p className="text-gray-600 text-lg animate-on-scroll">Стратегия продуктового дизайна под ваши потребности</p>
          </div>
